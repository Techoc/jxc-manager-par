...
import cn.techoc.jxcadmin.mapper.CustomerMapper;
import cn.techoc.jxcadmin.query.CustomerQuery;
import cn.techoc.jxcadmin.service.ICustomerService;
...
public class CustomerServiceImpl extends ServiceImpl<CustomerMapper, Customer>
    ...
    public Map<String, Object> customerList(CustomerQuery customerQuery) {
        IPage<Customer> page =
            new Page<Customer>(customerQuery.getPage(), customerQuery.getLimit());
